describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'Scads')
  ...
  it('loads the BNB and tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb #pair').should('contain.text', 'Scads')
  })
  ...
  it('does not crash if address is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'Scads')
    cy.get('#add-liquidity-input-tokenb #pair').should('not.contain.text', 'Scads')
  })
