...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@scads/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in Scads prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with Scads, win Scads if your numbers match')}
        </Text>
      </Flex>
