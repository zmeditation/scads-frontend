...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@scads/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'Scads card' },
    { src: 'green', alt: 'Green Scads card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'Scads card' },
  ],
}
