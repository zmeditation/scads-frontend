...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and Scads pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and Scads pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from Scads pool', data)
  }
