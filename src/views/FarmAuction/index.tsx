...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from '@scads/uikit'
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid Scads for the right to host a 7-day Farm on ScadsSwap.')}
            </Text>
