...
import { CardBody, Flex, Text, CardRibbon } from '@scads/uikit'
...
import CaratCardActions from './CardActions/CaratCardActions'

const CaratPoolCard: React.FC<{ pool: DeserializedPool; account: string }> = ({ pool, account }) => {
    ...
    >
      ...
      <CardBody>
        ...
        <Flex mt="24px" flexDirection="column">
          {account ? (
            <CaratCardActions pool={pool} stakedBalance={stakedBalance} />
          ) : (
            <>
