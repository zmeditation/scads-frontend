...
import ScadsCardActions from './CardActions/ScadsCardActions'

const ScadsPoolCard: React.FC<{ pool: DeserializedPool; account: string }> = ({ pool, account }) => {
    ...
    >
      ...
      <CardBody>
        ...
        <Flex mt="24px" flexDirection="column">
          {account ? (
            <ScadsCardActions pool={pool} stakedBalance={stakedBalance} />
          ) : (
            <>
