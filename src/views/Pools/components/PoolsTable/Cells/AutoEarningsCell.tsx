...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useMatchBreakpoints } from '@scads/uikit'
...
const AutoEarningsCell: React.FC<AutoEarningsCellProps> = ({ pool, account }) => {
  ...
  const labelText = t('Recent Scads profit')
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoCakeToDisplay} decimals={3} bold unit=" Scads" />
