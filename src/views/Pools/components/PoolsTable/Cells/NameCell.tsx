...
import { Text, useMatchBreakpoints, TokenPairImage as UITokenPairImage } from '@scads/uikit'
...
const NameCell: React.FC<NameCellProps> = ({ pool }) => {
  ...
  if (vaultKey) {
    ...
    title = t('Manual Scads')
    subtitle = `${t('Earn')} Scads ${t('Stake').toLocaleLowerCase()} Scads`
  }
